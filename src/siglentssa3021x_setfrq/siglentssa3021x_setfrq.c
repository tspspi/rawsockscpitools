...
int main(int argc, char* argv[]) {
    ...
    if(dFrequencyHz < 0) { printf("Frequencies below 0 are not supported\n"); return 1; }
    if(dFrequencyHz > 2100000000.0) { printf("Frequencies below above 2.1 GHz are not supported\n"); return 1; }
    ...
    lpSSA3021X->vtbl->setFrequencyCenter(lpSSA3021X, dFrequencyHz);
